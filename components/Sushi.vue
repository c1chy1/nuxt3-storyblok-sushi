...
<div class="container mx-auto relative flex flex-col justify-center items-center h-screen w-full box-border" ref="scope">
  <svg xmlns="http://www.w3.org/2000/svg" width="1181" height="595" viewBox="0 0 1181 595" >
      <g id="sushi" transform="translate(-93 -86)">
        ...
        <g ref="sushi2" id="sushi-02"
           transform="matrix(0.788, -0.616, 0.616, 0.788, 405, 585)">
  ...
  <h1 ref="heading" class="heading text-3xl font-display">Your Sushi is Ready 😊</h1>
